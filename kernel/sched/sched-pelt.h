...
/* 16ms half-life: y^16 ≈ 0.5, period = 16ms */
...
static const u32 runnable_avg_yN_sum[] __maybe_unused = {
	    0, 1002, 1982, 2941, 3880, 4798, 5697, 6576,
	   7437, 8279, 9103, 9909, 10698, 11470, 12226, 12966,
};

#define LOAD_AVG_PERIOD 16
#define LOAD_AVG_MAX 24130
#elif defined(CONFIG_PELT_UTIL_HALFLIFE_8)
/* 8ms half-life: y^8 ≈ 0.5, period = 8ms */
static const u32 runnable_avg_yN_inv[] __maybe_unused = {
...
static const u32 runnable_avg_yN_sum[] __maybe_unused = {
	    0,  980, 1919, 2818, 3679, 4503, 5292, 6048,
	   6772, 7465, 8129, 8764, 9373, 9956, 10514, 11048,
};

#define LOAD_AVG_PERIOD 8
#define LOAD_AVG_MAX 12326
#else
/* 32ms half-life: y^32 ≈ 0.5, period = 32ms (default) */
static const u32 runnable_avg_yN_inv[] __maybe_unused = {
